...
const FrienPending = ({ provider, user }) => {
    ...
    const confirmed = async () => {
        ...
        //now delete this provider from friendsPending and put this inside friends
        try {
            ...
            console.log("error in doing pending to confirm in FrienPending ", error)
        }
    }
